...
-- CreateEnum
CREATE TYPE "public"."orderstatus" AS ENUM ('Ordered', 'Confirmed', 'Preparing', 'Finished');

-- CreateEnum
CREATE TYPE "public"."payment" AS ENUM ('Cash', 'Mobile banking');
...
CREATE TABLE "public"."optiongroup" (
    "id" UUID NOT NULL DEFAULT gen_random_uuid(),
    "name" VARCHAR(50) NOT NULL,
    "can_have_many" BOOLEAN NOT NULL,
    "created_at" TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP,
    "store_id" UUID,
...
CREATE TABLE "public"."ordermenu" (
    ...
    "payment_method" "public"."payment" NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "optiongroup_name_key" ON "public"."optiongroup"("name");

-- CreateIndex
CREATE UNIQUE INDEX "optionitem_name_key" ON "public"."optionitem"("name");
...
-- CreateIndex
CREATE UNIQUE INDEX "store_phone_number_key" ON "public"."store"("phone_number");
...
-- AddForeignKey
ALTER TABLE "public"."account" ADD CONSTRAINT "account_role_id_fkey" FOREIGN KEY ("role_id") REFERENCES "public"."userrole"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."menucategory" ADD CONSTRAINT "menucategory_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "public"."store"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."menuitem" ADD CONSTRAINT "menuitem_menu_category_id_fkey" FOREIGN KEY ("menu_category_id") REFERENCES "public"."menucategory"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."menuitemoption" ADD CONSTRAINT "menuitemoption_menu_item_id_fkey" FOREIGN KEY ("menu_item_id") REFERENCES "public"."menuitem"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."menuitemoption" ADD CONSTRAINT "menuitemoption_option_group_id_fkey" FOREIGN KEY ("option_group_id") REFERENCES "public"."optiongroup"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."optiongroup" ADD CONSTRAINT "optiongroup_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "public"."store"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."optionitem" ADD CONSTRAINT "optionitem_option_group_id_fkey" FOREIGN KEY ("option_group_id") REFERENCES "public"."optiongroup"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."orderitem" ADD CONSTRAINT "orderitem_menu_item_id_fkey" FOREIGN KEY ("menu_item_id") REFERENCES "public"."menuitem"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."orderitem" ADD CONSTRAINT "orderitem_order_id_fkey" FOREIGN KEY ("order_id") REFERENCES "public"."ordermenu"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."orderitemoption" ADD CONSTRAINT "orderitemoption_menu_item_option_id_fkey" FOREIGN KEY ("menu_item_option_id") REFERENCES "public"."optionitem"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."orderitemoption" ADD CONSTRAINT "orderitemoption_order_item_id_fkey" FOREIGN KEY ("order_item_id") REFERENCES "public"."orderitem"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."ordermenu" ADD CONSTRAINT "ordermenu_store_id_fkey" FOREIGN KEY ("store_id") REFERENCES "public"."store"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."ordermenu" ADD CONSTRAINT "ordermenu_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."account"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "public"."store" ADD CONSTRAINT "store_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."account"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
